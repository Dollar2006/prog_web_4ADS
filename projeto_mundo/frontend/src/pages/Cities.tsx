...
const Cities: React.FC = () => {
      ...
      const [
        ...
        cityService.getCities(
          selectedCountryId
            ...
            : selectedContinentId
            ? { continentId: parseInt(selectedContinentId) }
            : undefined
        ),
  ...
  useEffect(() => {
    loadData();
  }, [selectedContinentId, selectedCountryId]);
      ...
      <header className="page-header">
        <div>
          ...
          <div className="page-subtitle">
            {filteredCities.length} cidades cadastradas
          </div>
        </div>
